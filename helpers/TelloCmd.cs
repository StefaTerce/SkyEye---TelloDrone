...
namespace tellocs
{
    ...
    public class TelloCmd : Tello
    {
        ...
        public void RunCommandFromFile(string fileName)
        {
            ...
            try
            {
                _log.Debug($"Loading command file: {fileName}");
        ...
        internal bool SendCommand(string v)
        {
            throw new NotImplementedException();
        }

        internal bool Flip(TelloFlipDirection left)
        {
            TelloResponse response = SendMessage($"flip {left}", waitForResponse: true, timeOutMs: 5000);
            return response.Ok;
        }
